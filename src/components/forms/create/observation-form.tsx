                        ...
                        <div className=''>
                            ...
                            <div className="flex items-center ">
                                <label
                                    className="font-bold text-gray-800 mx-8 "
                                    htmlFor="startDate">
                                    <span className="text-red-500">*</span> Observation Start Date:
                                </label>
                        ...
                        <div className=''>
                            ...
                            <div className='flex items-center'>
                                <label
                                    ...
                                    htmlFor="startTime">
                                    <span className="text-red-500">*</span> Observation Start Time:
                                </label>
                                <div className='border rounded-md'>
                ...
                <div className="flex items-center">
                    ...
                    <div className=''>
                        <label
                           ...
                           {isCheck && <span className='text-red-500'>*</span>} Flux Density (µJy):
                        </label>
                        <input
                            type="text"
                    ...
                    <div className=''>
                        <label
                            className="font-bold text-gray-800 mx-8"
                            htmlFor="uncertainty">
                             {isCheck && <span className='text-red-500'>*</span>}  Flux Density Error (µJy):
                        </label>
                        <input
                            type="text"
