                ...
                >
                    ...
                    <div className='flex flex-col text-center w-9/12 h-3/6 my-20 rounded-md mx-auto'>
                        ...
                        <div className='text-center p-10'>
                            You are about to delete event <span className='font-bold'>{name}</span>, which will include deleting all <span className='font-extrabold text-blue-600 '>{observations.length}</span> of this events observations.
                        </div>
                        <div className='text-center p-10 text-red-600 font-bold'>Are you sure you want to delete event <span className='font-bold'>{name}</span>?</div>
                        <div className=' p-10'>
